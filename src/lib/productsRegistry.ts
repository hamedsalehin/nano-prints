...
- Dynamic Visual Impact: High-resolution UV printing at 1440 DPI delivers vivid, fade-resistant colors that command attention across crowded halls.`,
  ...
  "signs-supply": {
    ...
    products: [
      {
        id: "a-frame-sign",
        name: "A Frame Sign 24x36In Double-Sided Black Metal Slide-in Folding",
        ...
        badge: "Essential",
        config: {
          title: "A Frame Sign 24x36In Double-Sided Black Metal Slide-in Folding",
          subtitle: "Heavy-Duty Coated Steel Frame Sidewalk Curb Sign (Frame only)",
          ...
          selects: [
            {
              label: "Turnaround",
              options: [
                { label: "1-2 days", value: "1-2 days", price: 0 }
              ]
            }
          ],
          ...
          useCases: ["Sign fabrication", "Retail displays", "Outdoor advertising"],
          specs: [
      ...
      {
        id: "roll-up-banner",
        name: "Retractable (Roll Up ) Banner Stand Base, Metal Stand Replacement + Black Bag",
        ...
        badge: "Popular",
        config: {
          title: "Retractable Banner Stand 33\"x79\" Base, Metal Stand Replacement + Black Bag",
          subtitle: "Roll Up Stand Aluminum Trade Show/Event/Photo Booth (Base Only No Print)",
          breadcrumb: "Signs Supply",
          breadcrumbHref: "/signs-supply",
          promoText: "WHOLESALE PRICING FOR SIGNMAKERS",
          image: "/images/products/signs-supply/roll-up-banner.png",
          images: [
            "/images/products/signs-supply/roll-up-banner.png",
            "/images/products/signs-supply/roll-up-banner-2.jpg",
            "/images/products/signs-supply/roll-up-banner-3.jpg",
            "/images/products/signs-supply/roll-up-banner-4.jpg",
            "/images/products/signs-supply/roll-up-banner-5.jpg"
          ],
          sizes: [
          ...
          useCases: ["Trade shows", "Events", "Photo booths"],
          specs: [
      ...
      },
      {
        ...
        badge: "Reliable",
        config: {
          title: "12V LED Power Supply",
          subtitle: "Waterproof Transformer (60W/100W)",
          breadcrumb: "Signs Supply",
          breadcrumbHref: "/signs-supply",
          promoText: "WHOLESALE PRICING FOR SIGNMAKERS",
          image: "/images/products/signs-supply/power-supply-12v.jpeg",
          sizes: [
            { label: "Standard", value: "standard", basePrice: 25 }
          ],
          selects: [
            {
              label: "Turnaround",
          ...
          qtyDiscount: "Bulk discounts available for orders over 50 units.",
          keyFeatures: ["Trade quality", "Durable materials", "Fast shipping for signmakers"],
          useCases: ["Sign fabrication", "Retail displays", "Outdoor advertising"],
          specs: [],
          faqs: [],
          reviews: [],
      ...
      },
      {
        ...
        name: "S-Type Neon Strip + Silicone rubber",
        description: "Flexible LED Neon Rope Light (12V)",
        image: "/images/products/signs-supply/s-strip-silicone-neon.jpeg",
        price: "$35.00",
        badge: "New",
        config: {
          title: "S-Type Neon Strip + Silicone rubber",
          subtitle: "Flexible LED Neon Rope Light (12V)",
          breadcrumb: "Signs Supply",
          breadcrumbHref: "/signs-supply",
          promoText: "WHOLESALE PRICING FOR SIGNMAKERS",
          image: "/images/products/signs-supply/s-strip-silicone-neon.jpeg",
          sizes: [
            { label: "5 miter", value: "5 miter", basePrice: 35 }
          ],
          selects: [
            {
              label: "Turnaround",
          ...
          qtyDiscount: "Bulk discounts available for orders over 50 units.",
          keyFeatures: ["Trade quality", "Durable materials", "Fast shipping for signmakers"],
          useCases: ["Sign fabrication", "Neon displays", "Decorative lighting"],
          specs: [],
          faqs: [],
          reviews: [],
          ctaHeading: "Stock up on supplies",
      ...
      {
        id: "led-module-white",
        name: "LED Display Modules ( P 5, P 3.9, P 2.6)",
        description: "Bright White 12V Modules for Channel Letters",
        image: "/images/products/signs-supply/led-display-modules.png",
        price: "$25.50",
        config: {
          title: "LED Display Modules ( P 5, P 3.9, P 2.6)",
          subtitle: "Bright White 12V Modules for Channel Letters",
          breadcrumb: "Signs Supply",
          breadcrumbHref: "/signs-supply",
          promoText: "WHOLESALE PRICING FOR SIGNMAKERS",
          image: "/images/products/signs-supply/led-display-modules.png",
          sizes: [
            { label: "Standard", value: "standard", basePrice: 25.50 }
          ],
          selects: [
            {
              label: "Turnaround",
          ...
          qtyDiscount: "Bulk discounts available for orders over 50 units.",
          keyFeatures: ["Trade quality", "Durable materials", "Fast shipping for signmakers"],
          useCases: ["Channel letters", "LED displays", "Sign fabrication"],
          specs: [],
          faqs: [],
          reviews: [],
          ctaHeading: "Stock up on supplies",
